...
public class ReactiveCosmosTemplateIllegalTest {
    ...
    public void deleteIllegalShouldFail() throws NoSuchMethodException {
        ...
        final Criteria criteria = Criteria.getInstance(IS_EQUAL, "faker", Arrays.asList(DUMMY_STR));
    ...
    public void deleteIllegalCollectionShouldFail() throws NoSuchMethodException {
        ...
        checkIllegalArgument(method, NULL_STR, "id");
        checkIllegalArgument(method, EMPTY_STR, "id");
        checkIllegalArgument(method, WHITESPACES_STR, "id");
    }
