...
public class MemoRepositoryIT {
    ...
    private static final String DATE_1 = "1/1/2000";


    private static final String ID_2 = "id_2";
    private static final String MESSAGE_2 = "second message";
    private static final String DATE_2 = "1/1/2001";
    ...
    public void setup() throws ParseException{
        date1 = DATE_FORMAT.parse(DATE_1);
        date2 = DATE_FORMAT.parse(DATE_2);
    ...
    public void testFindByDate() throws ParseException {
        final List<Memo> result = repository.findMemoByDate(DATE_FORMAT.parse(DATE_1));
